...
// $ANTLR 3.4.1.9004 ../ChimpyLang/lang/ChimpyLexer.g 2012-09-09 01:22:09
...
public partial class ChimpyLexer : Antlr.Runtime.Lexer
{
	...
	public override string GrammarFileName { get { return "../ChimpyLang/lang/ChimpyLexer.g"; } }
	...
	private void mCLASS()
	{
		...
		try
		{
			...
			// ../ChimpyLang/lang/ChimpyLexer.g:31:6: ({...}? => 'class' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:31:21: {...}? => 'class'
			{
			DebugLocation(31, 21);
			if (!((!methodMode)))
			{
	...
	private void mDEF()
	{
		...
		try
		{
			int _type = DEF;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:32:4: ({...}? => 'def' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:32:21: {...}? => 'def'
			{
			DebugLocation(32, 21);
			if (!((!methodMode)))
			{
	...
	private void mIF()
	{
		...
		try
		{
			int _type = IF;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:33:3: ({...}? => 'if' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:33:21: {...}? => 'if'
			{
			DebugLocation(33, 21);
			if (!((!methodMode)))
			{
	...
	private void mELSE()
	{
		...
		try
		{
			int _type = ELSE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:34:5: ({...}? => 'else' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:34:21: {...}? => 'else'
			{
			DebugLocation(34, 21);
			if (!((!methodMode)))
			{
	...
	private void mWHILE()
	{
		...
		try
		{
			int _type = WHILE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:35:6: ({...}? => 'while' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:35:21: {...}? => 'while'
			{
			DebugLocation(35, 21);
			if (!((!methodMode)))
			{
	...
	private void mTRY()
	{
		...
		try
		{
			int _type = TRY;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:36:4: ({...}? => 'try' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:36:21: {...}? => 'try'
			{
			DebugLocation(36, 21);
			if (!((!methodMode)))
			{
	...
	private void mCATCH()
	{
		...
		try
		{
			int _type = CATCH;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:37:6: ({...}? => 'catch' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:37:21: {...}? => 'catch'
			{
			DebugLocation(37, 21);
			if (!((!methodMode)))
			{
	...
	private void mEND()
	{
		...
		try
		{
			int _type = END;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:38:4: ({...}? => 'end' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:38:21: {...}? => 'end'
			{
			DebugLocation(38, 21);
			if (!((!methodMode)))
			{
	...
	private void mSELF()
	{
		...
		try
		{
			int _type = SELF;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:39:5: ({...}? => 'self' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:39:21: {...}? => 'self'
			{
			DebugLocation(39, 21);
			if (!((!methodMode)))
			{
	...
	private void mNIL()
	{
		...
		try
		{
			int _type = NIL;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:40:4: ({...}? => 'nil' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:40:21: {...}? => 'nil'
			{
			DebugLocation(40, 21);
			if (!((!methodMode)))
			{
	...
	private void mTRUE()
	{
		...
		try
		{
			int _type = TRUE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:41:5: ({...}? => 'true' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:41:21: {...}? => 'true'
			{
			DebugLocation(41, 21);
			if (!((!methodMode)))
			{
	...
	private void mFALSE()
	{
		...
		try
		{
			int _type = FALSE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:42:6: ({...}? => 'false' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:42:21: {...}? => 'false'
			{
			DebugLocation(42, 21);
			if (!((!methodMode)))
			{
	...
	private void mINTEGER()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:46:17: ()
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:46:18: 
			{
			}
	...
	private void mFLOAT()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:47:15: ()
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:47:16: 
			{
			}
	...
	private void mNUMBER()
	{
		...
		try
		{
			int _type = NUMBER;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:48:7: ( ( '-' )? ( DIGIT )+ ({...}? => '.' ( DIGIT )+ |) )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:48:21: ( '-' )? ( DIGIT )+ ({...}? => '.' ( DIGIT )+ |)
			{
			DebugLocation(48, 21);
			// ../ChimpyLang/lang/ChimpyLexer.g:48:21: ( '-' )?
			int alt1=2;
			...
			DebugLocation(48, 26);
			// ../ChimpyLang/lang/ChimpyLexer.g:48:26: ( DIGIT )+
			int cnt2=0;
			...
			DebugLocation(50, 23);
			// ../ChimpyLang/lang/ChimpyLexer.g:50:23: ({...}? => '.' ( DIGIT )+ |)
			int alt4=2;
			try { DebugEnterSubRule(4);
			try { DebugEnterDecision(4, false);
			int LA4_1 = input.LA(1);

			if ((LA4_1=='.') && ((isNum(input.LA(2)))))
			{
				alt4 = 1;
			}
			else
			...
			case 1:
				DebugEnterAlt(1);
				// ../ChimpyLang/lang/ChimpyLexer.g:50:25: {...}? => '.' ( DIGIT )+
				{
				DebugLocation(50, 25);
				if (!((isNum(input.LA(2)))))
				{
				...
				Match('.'); 
				DebugLocation(50, 53);
				// ../ChimpyLang/lang/ChimpyLexer.g:50:53: ( DIGIT )+
				int cnt3=0;
			...
			case 2:
				DebugEnterAlt(2);
				// ../ChimpyLang/lang/ChimpyLexer.g:51:61: 
				{
				DebugLocation(51, 61);
				 _type = INTEGER; 
	...
	private void mSTRING()
	{
		...
		try
		{
			int _type = STRING;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:53:7: ( '\"' (~ ( '\\\\' | '\"' ) )* '\"' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:53:21: '\"' (~ ( '\\\\' | '\"' ) )* '\"'
			{
			DebugLocation(53, 21);
			Match('\"'); 
			DebugLocation(53, 25);
			// ../ChimpyLang/lang/ChimpyLexer.g:53:25: (~ ( '\\\\' | '\"' ) )*
	...
	private void mNAME()
	{
		...
		try
		{
			int _type = NAME;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:54:5: ( ( LOWER | '_' ) ( ID_CHAR )* ( '!' | '?' )? )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:54:21: ( LOWER | '_' ) ( ID_CHAR )* ( '!' | '?' )?
			{
			DebugLocation(54, 21);
			...
			DebugLocation(54, 35);
			// ../ChimpyLang/lang/ChimpyLexer.g:54:35: ( ID_CHAR )*
			...
			DebugLocation(54, 44);
			// ../ChimpyLang/lang/ChimpyLexer.g:54:44: ( '!' | '?' )?
			int alt7=2;
	...
	private void mCONSTANT()
	{
		...
		try
		{
			int _type = CONSTANT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:55:9: ( UPPER ( ID_CHAR )* )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:55:21: UPPER ( ID_CHAR )*
			{
			DebugLocation(55, 21);
			mUPPER(); 
			DebugLocation(55, 27);
			// ../ChimpyLang/lang/ChimpyLexer.g:55:27: ( ID_CHAR )*
	...
	private void mSEMICOLON()
	{
		...
		try
		{
			int _type = SEMICOLON;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:58:10: ( ';' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:58:21: ';'
			{
			DebugLocation(58, 21);
			Match(';'); 
	...
	private void mCOLON()
	{
		...
		try
		{
			int _type = COLON;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:59:6: ( ':' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:59:21: ':'
			{
			DebugLocation(59, 21);
			Match(':'); 
	...
	private void mDOT()
	{
		...
		try
		{
			int _type = DOT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:60:4: ( '.' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:60:21: '.'
			{
			DebugLocation(60, 21);
			Match('.'); 
			DebugLocation(60, 25);
	...
	private void mCOMMA()
	{
		...
		try
		{
			int _type = COMMA;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:61:6: ( ',' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:61:21: ','
			{
			DebugLocation(61, 21);
			Match(','); 
	...
	private void mOPEN_PARENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:62:12: ( '(' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:62:21: '('
			{
			DebugLocation(62, 21);
			Match('('); 
	...
	private void mCLOSE_PARENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:63:13: ( ')' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:63:21: ')'
			{
			DebugLocation(63, 21);
			Match(')'); 
	...
	private void mAT()
	{
		...
		try
		{
			int _type = AT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:64:3: ( '@' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:64:21: '@'
			{
			DebugLocation(64, 21);
			Match('@'); 
	...
	private void mEQ()
	{
		...
		try
		{
			int _type = EQ;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:65:3: ( '==' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:65:21: '=='
			{
			DebugLocation(65, 21);
			Match("=="); 
	...
	private void mLE()
	{
		...
		try
		{
			int _type = LE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:66:3: ( '<=' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:66:21: '<='
			{
			DebugLocation(66, 21);
			Match("<="); 
	...
	private void mGE()
	{
		...
		try
		{
			int _type = GE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:67:3: ( '>=' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:67:21: '>='
			{
			DebugLocation(67, 21);
			Match(">="); 
	...
	private void mLT()
	{
		...
		try
		{
			int _type = LT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:68:3: ( '<' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:68:21: '<'
			{
			DebugLocation(68, 21);
			Match('<'); 
	...
	private void mGT()
	{
		...
		try
		{
			int _type = GT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:69:3: ( '>' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:69:21: '>'
			{
			DebugLocation(69, 21);
			Match('>'); 
	...
	private void mPLUS()
	{
		...
		try
		{
			int _type = PLUS;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:70:5: ( '+' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:70:21: '+'
			{
			DebugLocation(70, 21);
			Match('+'); 
	...
	private void mMINUS()
	{
		...
		try
		{
			int _type = MINUS;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:71:6: ( '-' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:71:21: '-'
			{
			DebugLocation(71, 21);
			Match('-'); 
	...
	private void mMUL()
	{
		...
		try
		{
			int _type = MUL;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:72:4: ( '*' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:72:21: '*'
			{
			DebugLocation(72, 21);
			Match('*'); 
	...
	private void mDIV()
	{
		...
		try
		{
			int _type = DIV;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:73:4: ( '/' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:73:21: '/'
			{
			DebugLocation(73, 21);
			Match('/'); 
	...
	private void mMOD()
	{
		...
		try
		{
			int _type = MOD;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:74:4: ( '%' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:74:21: '%'
			{
			DebugLocation(74, 21);
			Match('%'); 
	...
	private void mAND()
	{
		...
		try
		{
			int _type = AND;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:75:4: ( '&&' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:75:21: '&&'
			{
			DebugLocation(75, 21);
			Match("&&"); 
	...
	private void mOR()
	{
		...
		try
		{
			int _type = OR;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:76:3: ( '||' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:76:21: '||'
			{
			DebugLocation(76, 21);
			Match("||"); 
	...
	private void mNOT()
	{
		...
		try
		{
			int _type = NOT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:77:4: ( '!' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:77:21: '!'
			{
			DebugLocation(77, 21);
			Match('!'); 
	...
	private void mASSIGN()
	{
		...
		try
		{
			int _type = ASSIGN;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:78:7: ( '=' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:78:21: '='
			{
			DebugLocation(78, 21);
			Match('='); 
	...
	private void mCOMMENT()
	{
		...
		try
		{
			int _type = COMMENT;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:80:8: ( '#' (~ ( '\\r' | '\\n' ) )* ( NEWLINE | EOF ) )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:80:21: '#' (~ ( '\\r' | '\\n' ) )* ( NEWLINE | EOF )
			{
			DebugLocation(80, 21);
			Match('#'); 
			DebugLocation(80, 25);
			// ../ChimpyLang/lang/ChimpyLexer.g:80:25: (~ ( '\\r' | '\\n' ) )*
			...
			DebugLocation(80, 41);
			// ../ChimpyLang/lang/ChimpyLexer.g:80:41: ( NEWLINE | EOF )
			int alt10=2;
			...
			case 1:
				DebugEnterAlt(1);
				// ../ChimpyLang/lang/ChimpyLexer.g:80:42: NEWLINE
				{
				DebugLocation(80, 42);
				mNEWLINE(); 
			...
			case 2:
				DebugEnterAlt(2);
				// ../ChimpyLang/lang/ChimpyLexer.g:80:52: EOF
				{
				DebugLocation(80, 52);
				Match(EOF); 
	...
	private void mNEWLINE()
	{
		...
		try
		{
			int _type = NEWLINE;
			int _channel = DefaultTokenChannel;
			// ../ChimpyLang/lang/ChimpyLexer.g:82:8: ( ( '\\r' )? '\\n' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:82:21: ( '\\r' )? '\\n'
			{
			DebugLocation(82, 21);
			// ../ChimpyLang/lang/ChimpyLexer.g:82:21: ( '\\r' )?
			int alt11=2;
	...
	private void mLETTER()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:85:16: ( LOWER | UPPER )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:
			{
			DebugLocation(85, 16);
	...
	private void mID_CHAR()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:86:17: ( LETTER | DIGIT | '_' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:
			{
			DebugLocation(86, 17);
	...
	private void mLOWER()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:87:15: ( 'a' .. 'z' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:
			{
			DebugLocation(87, 15);
	...
	private void mUPPER()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:88:15: ( 'A' .. 'Z' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:
			{
			DebugLocation(88, 15);
	...
	private void mDIGIT()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:89:15: ( '0' .. '9' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:
			{
			DebugLocation(89, 15);
	...
	private void mSPACE()
	{
		...
		try
		{
			// ../ChimpyLang/lang/ChimpyLexer.g:90:15: ( ' ' | '\\t' )
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:
			{
			DebugLocation(90, 15);
	...
	{
		// ../ChimpyLang/lang/ChimpyLexer.g:1:8: ( CLASS | DEF | IF | ELSE | WHILE | TRY | CATCH | END | SELF | NIL | TRUE | FALSE | NUMBER | STRING | NAME | CONSTANT | SEMICOLON | COLON | DOT | COMMA | OPEN_PARENT | CLOSE_PARENT | AT | EQ | LE | GE | LT | GT | PLUS | MINUS | MUL | DIV | MOD | AND | OR | NOT | ASSIGN | COMMENT | NEWLINE )
		int alt12=39;
		...
		case 1:
			DebugEnterAlt(1);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:10: CLASS
			{
			DebugLocation(1, 10);
			mCLASS(); 
		...
		case 2:
			DebugEnterAlt(2);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:16: DEF
			{
			DebugLocation(1, 16);
			mDEF(); 
		...
		case 3:
			DebugEnterAlt(3);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:20: IF
			{
			DebugLocation(1, 20);
			mIF(); 
		...
		case 4:
			DebugEnterAlt(4);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:23: ELSE
			{
			DebugLocation(1, 23);
			mELSE(); 
		...
		case 5:
			DebugEnterAlt(5);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:28: WHILE
			{
			DebugLocation(1, 28);
			mWHILE(); 
		...
		case 6:
			DebugEnterAlt(6);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:34: TRY
			{
			DebugLocation(1, 34);
			mTRY(); 
		...
		case 7:
			DebugEnterAlt(7);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:38: CATCH
			{
			DebugLocation(1, 38);
			mCATCH(); 
		...
		case 8:
			DebugEnterAlt(8);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:44: END
			{
			DebugLocation(1, 44);
			mEND(); 
		...
		case 9:
			DebugEnterAlt(9);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:48: SELF
			{
			DebugLocation(1, 48);
			mSELF(); 
		...
		case 10:
			DebugEnterAlt(10);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:53: NIL
			{
			DebugLocation(1, 53);
			mNIL(); 
		...
		case 11:
			DebugEnterAlt(11);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:57: TRUE
			{
			DebugLocation(1, 57);
			mTRUE(); 
		...
		case 12:
			DebugEnterAlt(12);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:62: FALSE
			{
			DebugLocation(1, 62);
			mFALSE(); 
		...
		case 13:
			DebugEnterAlt(13);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:68: NUMBER
			{
			DebugLocation(1, 68);
			mNUMBER(); 
		...
		case 14:
			DebugEnterAlt(14);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:75: STRING
			{
			DebugLocation(1, 75);
			mSTRING(); 
		...
		case 15:
			DebugEnterAlt(15);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:82: NAME
			{
			DebugLocation(1, 82);
			mNAME(); 
		...
		case 16:
			DebugEnterAlt(16);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:87: CONSTANT
			{
			DebugLocation(1, 87);
			mCONSTANT(); 
		...
		case 17:
			DebugEnterAlt(17);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:96: SEMICOLON
			{
			DebugLocation(1, 96);
			mSEMICOLON(); 
		...
		case 18:
			DebugEnterAlt(18);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:106: COLON
			{
			DebugLocation(1, 106);
			mCOLON(); 
		...
		case 19:
			DebugEnterAlt(19);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:112: DOT
			{
			DebugLocation(1, 112);
			mDOT(); 
		...
		case 20:
			DebugEnterAlt(20);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:116: COMMA
			{
			DebugLocation(1, 116);
			mCOMMA(); 
		...
		case 21:
			DebugEnterAlt(21);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:122: OPEN_PARENT
			{
			DebugLocation(1, 122);
			mOPEN_PARENT(); 
		...
		case 22:
			DebugEnterAlt(22);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:134: CLOSE_PARENT
			{
			DebugLocation(1, 134);
			mCLOSE_PARENT(); 
		...
		case 23:
			DebugEnterAlt(23);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:147: AT
			{
			DebugLocation(1, 147);
			mAT(); 
		...
		case 24:
			DebugEnterAlt(24);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:150: EQ
			{
			DebugLocation(1, 150);
			mEQ(); 
		...
		case 25:
			DebugEnterAlt(25);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:153: LE
			{
			DebugLocation(1, 153);
			mLE(); 
		...
		case 26:
			DebugEnterAlt(26);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:156: GE
			{
			DebugLocation(1, 156);
			mGE(); 
		...
		case 27:
			DebugEnterAlt(27);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:159: LT
			{
			DebugLocation(1, 159);
			mLT(); 
		...
		case 28:
			DebugEnterAlt(28);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:162: GT
			{
			DebugLocation(1, 162);
			mGT(); 
		...
		case 29:
			DebugEnterAlt(29);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:165: PLUS
			{
			DebugLocation(1, 165);
			mPLUS(); 
		...
		case 30:
			DebugEnterAlt(30);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:170: MINUS
			{
			DebugLocation(1, 170);
			mMINUS(); 
		...
		case 31:
			DebugEnterAlt(31);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:176: MUL
			{
			DebugLocation(1, 176);
			mMUL(); 
		...
		case 32:
			DebugEnterAlt(32);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:180: DIV
			{
			DebugLocation(1, 180);
			mDIV(); 
		...
		case 33:
			DebugEnterAlt(33);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:184: MOD
			{
			DebugLocation(1, 184);
			mMOD(); 
		...
		case 34:
			DebugEnterAlt(34);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:188: AND
			{
			DebugLocation(1, 188);
			mAND(); 
		...
		case 35:
			DebugEnterAlt(35);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:192: OR
			{
			DebugLocation(1, 192);
			mOR(); 
		...
		case 36:
			DebugEnterAlt(36);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:195: NOT
			{
			DebugLocation(1, 195);
			mNOT(); 
		...
		case 37:
			DebugEnterAlt(37);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:199: ASSIGN
			{
			DebugLocation(1, 199);
			mASSIGN(); 
		...
		case 38:
			DebugEnterAlt(38);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:206: COMMENT
			{
			DebugLocation(1, 206);
			mCOMMENT(); 
		...
		case 39:
			DebugEnterAlt(39);
			// ../ChimpyLang/lang/ChimpyLexer.g:1:214: NEWLINE
			{
			DebugLocation(1, 214);
			mNEWLINE(); 
	...
	private class DFA12 : DFA
	{
		...
		private const string DFA12_specialS =
			"\x37\xFFFF\x1\x0\xA\xFFFF\x1\x1\x2\xFFFF\x1\x2\x1\xFFFF\x1\x3\x2\xFFFF"+
			"\x1\x4\x4\xFFFF\x1\x5\x3\xFFFF\x1\x6\x1\x7\x2\xFFFF\x1\x8\x1\x9\x1\xFFFF"+
			"\x1\xA\x2\xFFFF\x1\xB\x4\xFFFF}>";
